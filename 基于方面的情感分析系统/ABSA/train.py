...
from models import LSTM, TD_LSTM, TC_LSTM, ATAE_LSTM, LCF_BERT, TD_Transformer, TDLC_Transformer, TAGG_LSTM
...
class Instructor:
    def __init__(self, opt):
        ...
        if 'bert' in opt.model_name:
            ...
            if 'pt' in opt.model_name:
                bert = BertModel.from_pretrained('./pre_train/models/'+opt.pre_train_dataset)
            else:
...
def main():
    ...
    parser.add_argument('--model_name', default='tdlc_transformer', type=str)
    ...
    parser.add_argument('--pre_train_dataset', default='restaurant', type=str, help='twitter, restaurant, laptop, all')
    ...
    model_classes = {
        ...
        'tagg_lstm': TAGG_LSTM,
        'lcf_bert_iTopt': LCF_BERT,
        'lcf_bert_cTopt': LCF_BERT,
    ...
    input_colses = {
        ...
        'lcf_bert_iTopt': ['concat_bert_indices', 'concat_segments_indices', 'text_bert_indices', 'aspect_bert_indices'],
        'lcf_bert_cTopt': ['concat_bert_indices', 'concat_segments_indices', 'text_bert_indices', 'aspect_bert_indices'],
    }
    initializers = {
